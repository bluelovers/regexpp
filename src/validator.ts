...
export class RegExpValidator {
    ...
    /**
     * Validate a RegExp flags. E.g. "gim"
     * @param source The source code of RegExp flags to validate.
    ...
    /**
     * Validate a RegExp pattern. E.g. "abc"
     * @param source The source code of RegExp pattern to validate.
     * @param start The start index in the source code.
     * @param end The end index in the source code.
